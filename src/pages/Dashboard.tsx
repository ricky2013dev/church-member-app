...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    const hasWeeklySelection =
      viewMode === 'weekly' && selectedWeeks.length > 0;
    const hasMonthlySelection =
      viewMode === 'monthly' && selectedMonths.length > 0;
    ...
    <div className="container">
      ...
      <section className="card">
        {viewMode === 'weekly' ? (
          ...
          <>
            <h2 className="card-header">Monthly Registrations (12months)</h2>
