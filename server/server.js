...
app.post('/api/families', async (req, res) => {
  ...
  try {
    ...
    const { family_name, registration_status, input_date, notes, address, zipcode, life_group, family_picture_url, members, main_supporter_id, sub_supporter_id } = req.body;
    ...
    const familyResult = await client.query(familyQuery, [
      family_name, registration_status, input_date, notes || '', address || '', zipcode || '', life_group || '', family_picture_url || '', 
...
app.put('/api/families/:id', async (req, res) => {
  try {
    const familyId = parseInt(req.params.id);
    const { family_name, registration_status, input_date, notes, address, zipcode, life_group, family_picture_url, main_supporter_id, sub_supporter_id } = req.body;
